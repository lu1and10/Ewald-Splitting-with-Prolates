...
static constexpr int c_nbnxmEspSpecializedForceOrderMin4xm  = 6;
static constexpr int c_nbnxmEspSpecializedForceOrderMax4xm  = 22;
static constexpr int c_nbnxmEspSpecializedEnergyOrderMin4xm = 8;
static constexpr int c_nbnxmEspSpecializedEnergyOrderMax4xm = 22;

static int nbnxmEspAnalyticalCoulombKernelIndex4xm(const int coulkt)
{
...
static int nbnxmEspMeasuredOrderPairIndex4xm(const int forceOrder, const int energyOrder)
{
...
static NbnxmKernelFunc* const nbnxmKernelNoenerEspForceOrderSimd4xm[2][17][vdwktNR] = {
    {
            {
                    nbnxmKernelSimdImpl<KernelLayout::r4xM,
                                        KernelCoulombType::EwaldAnalytical,
                                        VdwCutoffCheck::No,
                                        LJCombinationRule::Geometric,
                                        InteractionModifiers::PotShift,
...
static NbnxmKernelFunc* const nbnxmKernelNoenerEspRuntimeOrderSimd4xm[2][vdwktNR] = {
    {
            nbnxmKernelSimdImpl<KernelLayout::r4xM,
                                KernelCoulombType::EwaldAnalytical,
                                VdwCutoffCheck::No,
...
static NbnxmKernelFunc* const nbnxmKernelEnerEspMeasuredOrderPairSimd4xm[2][7][vdwktNR] = {
    {
            {
                    nbnxmKernelSimdImpl<KernelLayout::r4xM,
                                        KernelCoulombType::EwaldAnalytical,
...
static NbnxmKernelFunc* const nbnxmKernelEnerEspEnergyOrderSimd4xm[2][15][vdwktNR] = {
    {
            {
                    nbnxmKernelSimdImpl<KernelLayout::r4xM,
                                        KernelCoulombType::EwaldAnalytical,
...
static NbnxmKernelFunc* const nbnxmKernelEnerEspRuntimeOrderSimd4xm[2][vdwktNR] = {
    {
            nbnxmKernelSimdImpl<KernelLayout::r4xM,
                                KernelCoulombType::EwaldAnalytical,
                                VdwCutoffCheck::No,
...
static NbnxmKernelFunc* const nbnxmKernelEnergrpEspMeasuredOrderPairSimd4xm[2][7][vdwktNR] = {
    {
            {
                    nbnxmKernelSimdImpl<KernelLayout::r4xM,
                                        KernelCoulombType::EwaldAnalytical,
...
static NbnxmKernelFunc* const nbnxmKernelEnergrpEspEnergyOrderSimd4xm[2][15][vdwktNR] = {
    {
            {
                    nbnxmKernelSimdImpl<KernelLayout::r4xM,
                                        KernelCoulombType::EwaldAnalytical,
...
static NbnxmKernelFunc* const nbnxmKernelEnergrpEspRuntimeOrderSimd4xm[2][vdwktNR] = {
    {
            nbnxmKernelSimdImpl<KernelLayout::r4xM,
                                KernelCoulombType::EwaldAnalytical,
                                VdwCutoffCheck::No,
...
static NbnxmKernelFunc* selectNbnxmKernelNoenerEspSimd4xm(const int coulkt, const int vdwkt, const int forceOrder)
{
    const int coulombIndex = nbnxmEspAnalyticalCoulombKernelIndex4xm(coulkt);
    if (coulombIndex < 0)
    {
        return nbnxmKernelNoenerSimd4xm[coulkt][vdwkt];
    }
    if (forceOrder >= c_nbnxmEspSpecializedForceOrderMin4xm && forceOrder <= c_nbnxmEspSpecializedForceOrderMax4xm)
    {
        return nbnxmKernelNoenerEspForceOrderSimd4xm[coulombIndex][forceOrder - c_nbnxmEspSpecializedForceOrderMin4xm][vdwkt];
    }
    return nbnxmKernelNoenerEspRuntimeOrderSimd4xm[coulombIndex][vdwkt];
}

static NbnxmKernelFunc* selectNbnxmKernelEnerEspSimd4xm(const int coulkt,
                                                        const int vdwkt,
                                                        ...
                                                        const int energyOrder)
{
    ...
    if (coulombIndex < 0)
    {
        return nbnxmKernelEnerSimd4xm[coulkt][vdwkt];
    }
    const int pairIndex = nbnxmEspMeasuredOrderPairIndex4xm(forceOrder, energyOrder);
    if (pairIndex >= 0)
    {
        return nbnxmKernelEnerEspMeasuredOrderPairSimd4xm[coulombIndex][pairIndex][vdwkt];
    }
    if (energyOrder >= c_nbnxmEspSpecializedEnergyOrderMin4xm
        && energyOrder <= c_nbnxmEspSpecializedEnergyOrderMax4xm)
    {
        return nbnxmKernelEnerEspEnergyOrderSimd4xm[coulombIndex][energyOrder - c_nbnxmEspSpecializedEnergyOrderMin4xm][vdwkt];
    }
    return nbnxmKernelEnerEspRuntimeOrderSimd4xm[coulombIndex][vdwkt];
}

static NbnxmKernelFunc* selectNbnxmKernelEnergrpEspSimd4xm(const int coulkt,
                                                           const int vdwkt,
                                                           const int forceOrder,
                                                           const int energyOrder)
{
    ...
    if (coulombIndex < 0)
    {
        return nbnxmKernelEnergrpSimd4xm[coulkt][vdwkt];
    }
    const int pairIndex = nbnxmEspMeasuredOrderPairIndex4xm(forceOrder, energyOrder);
    if (pairIndex >= 0)
    {
        return nbnxmKernelEnergrpEspMeasuredOrderPairSimd4xm[coulombIndex][pairIndex][vdwkt];
    }
    if (energyOrder >= c_nbnxmEspSpecializedEnergyOrderMin4xm
        && energyOrder <= c_nbnxmEspSpecializedEnergyOrderMax4xm)
    {
        return nbnxmKernelEnergrpEspEnergyOrderSimd4xm[coulombIndex][energyOrder - c_nbnxmEspSpecializedEnergyOrderMin4xm][vdwkt];
    }
    return nbnxmKernelEnergrpEspRuntimeOrderSimd4xm[coulombIndex][vdwkt];
}
