...
cp $SRCDIR/nvt-pme-9cut-p5-1.5e-5-single.tpr $RUNDIR
cp $SRCDIR/nvt-pme-9cut-p5-1.5e-5.mdp $RUNDIR
cd $RUNDIR
...
mpiexec --map-by socket:pe=1 $SRCDIR/gmx_mpi mdrun -dlb no -deffnm nvt-pme-9cut-p5-1.5e-5-single -npme 0 -notunepme -cpt -1
