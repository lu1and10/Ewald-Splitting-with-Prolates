...
parser.add_argument('--out',  type=str, default="voxelsout.dat", help='output with voxels to keep')
...
if(vars(args)["pdbC"]==None):
   print("Please specify a trajectory PDB with --pdbC")
...
print("there are %s frames"%nframes)
# cycle on frames
...
pickle.dump(tokeep,open(outfile,'wb'))
...
print("%37s %d" % ("# voxels for cc calculation:", len(tokeep)))
